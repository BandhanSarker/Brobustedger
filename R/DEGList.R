...
#' @import missForest
#' @import stats
#' @seealso Outliers identification function: \code{\link[Brobustedger]{iLOO}}, imputaion of missing/nullify function: \code{\link[Brobustedger]{NI}}, See details \code{\link[edgeR]{DGEList}}, \code{\link[missForest]{missForest}}, \code{\link[Brobustedger]{sampleDataMiss}} and \code{\link[Brobustedger]{sampleDataOut}}
#' @examples
...
#'@seealso Differentially expressed gene list: \code{\link[Brobustedger]{DEGList}}, Outliers identification function: \code{\link[Brobustedger]{iLOO}}, See details \code{\link[missForest]{missForest}} , \code{\link[Brobustedger]{sampleDataMiss}} and \code{\link[Brobustedger]{sampleDataOut}}
#'@examples
#'Brobustedger::NI(sampleDataMiss)  #Input RNA-seq count data with missing or null value
#' @export
NI<-function(data,mi=5, NT= 100){
m<-missForest::missForest(data, maxiter =mi, ntree =NT)
dataC<-m$ximp
return(dataC)
}
#######################################
...
#'@seealso Differentially expressed gene list: \code{\link[Brobustedger]{DEGList}}, Outliers identification function: \code{\link[Brobustedger]{iLOO}}, imputaion of missing/nullify function: \code{\link[Brobustedger]{NI}}, See details \code{\link[edgeR]{DGEList}} and \code{\link[missForest]{missForest}}
#'@author Bandhan Sarker, Md. Matiur Rahaman, Muhammad Habibulla Alamin, Md. Ariful Islam, and Md. Nurul Haque Mollah
#'@references
#'Robinson MD, McCarthy DJ and Smyth GK (2010). edgeR: a Bioconductor package for differential expression analysis of digital gene expression data. Bioinformatics 26, 139-140
#'
